...
<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
    ...
    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
      ...
      <div
        ...
        <!--begin::Heading-->
        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-2 my-0"><?= htmlspecialchars($page_title) ?></h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb fw-semibold fs-base my-1">
          <li class="breadcrumb-item text-muted">
            <a href="apps/dashboards/" class="text-muted text-hover-primary">Home</a>
          </li>
          <li class="breadcrumb-item text-muted"><?= htmlspecialchars($page_title) ?></li>
      ...
      <div class="d-flex d-lg-none align-items-center ms-n4 me-2">
        ...
        <!--begin::Logo-->
        <a href="apps/dashboards/" class="d-flex align-items-center">
      ...
      <div class="d-flex flex-shrink-0">
        ...
        <div class="d-flex align-items-center ms-3">
          <!--begin::Menu toggle-->
          <a href="#" class="btn btn-icon flex-center bg-body btn-color-gray-600 btn-active-color-primary h-40px"
